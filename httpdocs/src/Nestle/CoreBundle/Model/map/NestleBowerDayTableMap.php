 ...
 */
class NestleBowerDayTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Nestle.CoreBundle.Model.map.NestleBowerDayTableMap';
    ...
    public function initialize()
    {
        // attributes
        $this->setName('day');
        $this->setPhpName('NestleBowerDay');
        $this->setClassname('Nestle\\CoreBundle\\Model\\NestleBowerDay');

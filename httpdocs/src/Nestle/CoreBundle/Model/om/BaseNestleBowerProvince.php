...
abstract class BaseNestleBowerProvince extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Nestle\\CoreBundle\\Model\\NestleBowerProvincePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        NestleBowerProvincePeer
     */
     ...
     * @return NestleBowerProvince The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = NestleBowerProvincePeer::ID;
        }
    ...
    public function setProvince($v)
    {
        ...
        if ($this->province !== $v) {
            $this->province = $v;
            $this->modifiedColumns[] = NestleBowerProvincePeer::PROVINCE;
        }
    ...
    public function setRegionId($v)
    {
        ...
        if ($this->region_id !== $v) {
            $this->region_id = $v;
            $this->modifiedColumns[] = NestleBowerProvincePeer::REGION_ID;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = NestleBowerProvincePeer::STATUS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->province = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 4; // 4 = NestleBowerProvincePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating NestleBowerProvince object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = NestleBowerProvincePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = NestleBowerProvinceQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NestleBowerProvincePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NestleBowerProvincePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(NestleBowerProvincePeer::PROVINCE)) {
            $modifiedColumns[':p' . $index++]  = '`province`';
        }
        if ($this->isColumnModified(NestleBowerProvincePeer::REGION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`region_id`';
        }
        if ($this->isColumnModified(NestleBowerProvincePeer::STATUS)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = NestleBowerProvincePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = NestleBowerProvincePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['NestleBowerProvince'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['NestleBowerProvince'][$this->getPrimaryKey()] = true;
        $keys = NestleBowerProvincePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setProvince($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NestleBowerProvincePeer::ID)) $criteria->add(NestleBowerProvincePeer::ID, $this->id);
        if ($this->isColumnModified(NestleBowerProvincePeer::PROVINCE)) $criteria->add(NestleBowerProvincePeer::PROVINCE, $this->province);
        if ($this->isColumnModified(NestleBowerProvincePeer::REGION_ID)) $criteria->add(NestleBowerProvincePeer::REGION_ID, $this->region_id);
        if ($this->isColumnModified(NestleBowerProvincePeer::STATUS)) $criteria->add(NestleBowerProvincePeer::STATUS, $this->status);
    ...
    {
        $criteria = new Criteria(NestleBowerProvincePeer::DATABASE_NAME);
        $criteria->add(NestleBowerProvincePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of NestleBowerProvince (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return NestleBowerProvince Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return NestleBowerProvincePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new NestleBowerProvincePeer();
        }
    ...
    public function getNestleBowerRegion(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aNestleBowerRegion === null && ($this->region_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aNestleBowerRegion->addNestleBowerProvinces($this);
             */
        }
     ...
     * If this NestleBowerProvince is new, it will return
        ...
        if (null === $this->collNestleBowerCities || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collNestleBowerCities) {
                ...
                $collNestleBowerCities = NestleBowerCityQuery::create(null, $criteria)
                    ->filterByNestleBowerProvince($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setNestleBowerCities(PropelCollection $nestleBowerCities, PropelPDO $con = null)
    {
        ...
        foreach ($nestleBowerCitiesToDelete as $nestleBowerCityRemoved) {
            $nestleBowerCityRemoved->setNestleBowerProvince(null);
        }
    ...
    protected function doAddNestleBowerCity($nestleBowerCity)
    {
        ...
        $nestleBowerCity->setNestleBowerProvince($this);
    }
    ...
    public function removeNestleBowerCity($nestleBowerCity)
    {
        if ($this->getNestleBowerCities()->contains($nestleBowerCity)) {
            ...
            $nestleBowerCity->setNestleBowerProvince(null);
        }
    ...
    {
        return (string) $this->exportTo(NestleBowerProvincePeer::DEFAULT_STRING_FORMAT);
    }

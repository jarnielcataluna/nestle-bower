...
abstract class BaseNestleBowerInvoices extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Nestle\\CoreBundle\\Model\\NestleBowerInvoicesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        NestleBowerInvoicesPeer
     */
    ...
    /**
     * The value for the receipt_id field.
     * @var        string
     */
    ...
    /**
     * The value for the sold_to field.
     * @var        string
     */
    protected $sold_to;
    ...
    /**
     * Get the [receipt_id] column value.
     *
     * @return string
     */
     ...
     * @return NestleBowerInvoices The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = NestleBowerInvoicesPeer::ID;
        }
    ...
    /**
     * Set the value of [receipt_id] column.
     *
     * @param  string $v new value
     * @return NestleBowerInvoices The current object (for fluent API support)
     */
    public function setReceiptId($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->receipt_id !== $v) {
            $this->receipt_id = $v;
            $this->modifiedColumns[] = NestleBowerInvoicesPeer::RECEIPT_ID;
        }
    ...
    public function setInvoiceDate($v)
    {
        ...
        if ($this->invoice_date !== $v) {
            $this->invoice_date = $v;
            $this->modifiedColumns[] = NestleBowerInvoicesPeer::INVOICE_DATE;
        }
    ...
    public function setAccountId($v)
    {
        ...
        if ($this->account_id !== $v) {
            $this->account_id = $v;
            $this->modifiedColumns[] = NestleBowerInvoicesPeer::ACCOUNT_ID;
        }
    ...
    /**
     * Set the value of [sold_to] column.
     *
     * @param  string $v new value
     * @return NestleBowerInvoices The current object (for fluent API support)
     */
    public function setSoldTo($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->sold_to !== $v) {
            $this->sold_to = $v;
            $this->modifiedColumns[] = NestleBowerInvoicesPeer::SOLD_TO;
        }
    ...
    public function setBowerId($v)
    {
        ...
        if ($this->bower_id !== $v) {
            $this->bower_id = $v;
            $this->modifiedColumns[] = NestleBowerInvoicesPeer::BOWER_ID;
        }
    ...
    public function setSales($v)
    {
        ...
        if ($this->sales !== $v) {
            $this->sales = $v;
            $this->modifiedColumns[] = NestleBowerInvoicesPeer::SALES;
        }
    ...
    /**
     * Set the value of [skus] column.
     *
     * @param  int $v new value
     * @return NestleBowerInvoices The current object (for fluent API support)
     */
    public function setSkus($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }
        ...
        if ($this->skus !== $v) {
            $this->skus = $v;
            $this->modifiedColumns[] = NestleBowerInvoicesPeer::SKUS;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = NestleBowerInvoicesPeer::STATUS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->receipt_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->invoice_date = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->account_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->sold_to = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->bower_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->sales = ($row[$startcol + 6] !== null) ? (double) $row[$startcol + 6] : null;
            $this->skus = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            ...
            return $startcol + 9; // 9 = NestleBowerInvoicesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating NestleBowerInvoices object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = NestleBowerInvoicesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = NestleBowerInvoicesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NestleBowerInvoicesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NestleBowerInvoicesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(NestleBowerInvoicesPeer::RECEIPT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`receipt_id`';
        }
        if ($this->isColumnModified(NestleBowerInvoicesPeer::INVOICE_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`invoice_date`';
        }
        if ($this->isColumnModified(NestleBowerInvoicesPeer::ACCOUNT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`account_id`';
        }
        if ($this->isColumnModified(NestleBowerInvoicesPeer::SOLD_TO)) {
            $modifiedColumns[':p' . $index++]  = '`sold_to`';
        }
        if ($this->isColumnModified(NestleBowerInvoicesPeer::BOWER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bower_id`';
        }
        if ($this->isColumnModified(NestleBowerInvoicesPeer::SALES)) {
            $modifiedColumns[':p' . $index++]  = '`sales`';
        }
        if ($this->isColumnModified(NestleBowerInvoicesPeer::SKUS)) {
            $modifiedColumns[':p' . $index++]  = '`skus`';
        }
        if ($this->isColumnModified(NestleBowerInvoicesPeer::STATUS)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`receipt_id`':
                        $stmt->bindValue($identifier, $this->receipt_id, PDO::PARAM_STR);
                        break;
                    case '`invoice_date`':
                    ...
                    case '`account_id`':
                        ...
                        break;
                    case '`sold_to`':
                        $stmt->bindValue($identifier, $this->sold_to, PDO::PARAM_STR);
                        break;
                    case '`bower_id`':
                    ...
                    case '`sales`':
                        ...
                        break;
                    case '`skus`':
                        $stmt->bindValue($identifier, $this->skus, PDO::PARAM_INT);
                        break;
                    case '`status`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = NestleBowerInvoicesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = NestleBowerInvoicesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['NestleBowerInvoices'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['NestleBowerInvoices'][$this->getPrimaryKey()] = true;
        $keys = NestleBowerInvoicesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getReceiptId(),
            $keys[2] => $this->getInvoiceDate(),
            $keys[3] => $this->getAccountId(),
            $keys[4] => $this->getSoldTo(),
            $keys[5] => $this->getBowerId(),
            $keys[6] => $this->getSales(),
            $keys[7] => $this->getSkus(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setReceiptId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setInvoiceDate($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setAccountId($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setSoldTo($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setBowerId($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setSales($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setSkus($arr[$keys[7]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NestleBowerInvoicesPeer::ID)) $criteria->add(NestleBowerInvoicesPeer::ID, $this->id);
        if ($this->isColumnModified(NestleBowerInvoicesPeer::RECEIPT_ID)) $criteria->add(NestleBowerInvoicesPeer::RECEIPT_ID, $this->receipt_id);
        if ($this->isColumnModified(NestleBowerInvoicesPeer::INVOICE_DATE)) $criteria->add(NestleBowerInvoicesPeer::INVOICE_DATE, $this->invoice_date);
        if ($this->isColumnModified(NestleBowerInvoicesPeer::ACCOUNT_ID)) $criteria->add(NestleBowerInvoicesPeer::ACCOUNT_ID, $this->account_id);
        if ($this->isColumnModified(NestleBowerInvoicesPeer::SOLD_TO)) $criteria->add(NestleBowerInvoicesPeer::SOLD_TO, $this->sold_to);
        if ($this->isColumnModified(NestleBowerInvoicesPeer::BOWER_ID)) $criteria->add(NestleBowerInvoicesPeer::BOWER_ID, $this->bower_id);
        if ($this->isColumnModified(NestleBowerInvoicesPeer::SALES)) $criteria->add(NestleBowerInvoicesPeer::SALES, $this->sales);
        if ($this->isColumnModified(NestleBowerInvoicesPeer::SKUS)) $criteria->add(NestleBowerInvoicesPeer::SKUS, $this->skus);
        if ($this->isColumnModified(NestleBowerInvoicesPeer::STATUS)) $criteria->add(NestleBowerInvoicesPeer::STATUS, $this->status);
    ...
    {
        $criteria = new Criteria(NestleBowerInvoicesPeer::DATABASE_NAME);
        $criteria->add(NestleBowerInvoicesPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of NestleBowerInvoices (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return NestleBowerInvoices Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return NestleBowerInvoicesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new NestleBowerInvoicesPeer();
        }
    ...
    public function getNestleBowerAccountsMcp(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aNestleBowerAccountsMcp === null && ($this->account_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aNestleBowerAccountsMcp->addNestleBowerInvoicess($this);
             */
        }
    ...
    public function getNestleBower(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aNestleBower === null && ($this->bower_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aNestleBower->addNestleBowerInvoicess($this);
             */
        }
     ...
     * If this NestleBowerInvoices is new, it will return
        ...
        if (null === $this->collNestleBowerInvoiceItems || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collNestleBowerInvoiceItems) {
                ...
                $collNestleBowerInvoiceItems = NestleBowerInvoiceItemQuery::create(null, $criteria)
                    ->filterByNestleBowerInvoices($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setNestleBowerInvoiceItems(PropelCollection $nestleBowerInvoiceItems, PropelPDO $con = null)
    {
        ...
        foreach ($nestleBowerInvoiceItemsToDelete as $nestleBowerInvoiceItemRemoved) {
            $nestleBowerInvoiceItemRemoved->setNestleBowerInvoices(null);
        }
    ...
    protected function doAddNestleBowerInvoiceItem($nestleBowerInvoiceItem)
    {
        ...
        $nestleBowerInvoiceItem->setNestleBowerInvoices($this);
    }
    ...
    public function removeNestleBowerInvoiceItem($nestleBowerInvoiceItem)
    {
        if ($this->getNestleBowerInvoiceItems()->contains($nestleBowerInvoiceItem)) {
            ...
            $nestleBowerInvoiceItem->setNestleBowerInvoices(null);
        }
     ...
     * Otherwise if this NestleBowerInvoices is new, it will return
     * an empty collection; or if this NestleBowerInvoices has previously
     * been saved, it will retrieve related NestleBowerInvoiceItems from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in NestleBowerInvoices.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|NestleBowerInvoiceItem[] List of NestleBowerInvoiceItem objects
     */
    public function getNestleBowerInvoiceItemsJoinNestleBowerProduct($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = NestleBowerInvoiceItemQuery::create(null, $criteria);
    ...
    public function setNestleBowerSalesReportInvoices(PropelCollection $nestleBowerSalesReportInvoices, PropelPDO $con = null)
    {
        ...
        foreach ($nestleBowerSalesReportInvoicesToDelete as $nestleBowerSalesReportInvoiceRemoved) {
            $nestleBowerSalesReportInvoiceRemoved->setNestleBowerInvoices(null);
        }
    ...
    protected function doAddNestleBowerSalesReportInvoice($nestleBowerSalesReportInvoice)
    {
        ...
        $nestleBowerSalesReportInvoice->setNestleBowerInvoices($this);
    }
    ...
    public function removeNestleBowerSalesReportInvoice($nestleBowerSalesReportInvoice)
    {
        if ($this->getNestleBowerSalesReportInvoices()->contains($nestleBowerSalesReportInvoice)) {
            ...
            $nestleBowerSalesReportInvoice->setNestleBowerInvoices(null);
        }
     ...
     * @return PropelObjectCollection|NestleBowerSalesReportInvoice[] List of NestleBowerSalesReportInvoice objects
     */
    public function getNestleBowerSalesReportInvoicesJoinNestleBowerSalesReport($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = NestleBowerSalesReportInvoiceQuery::create(null, $criteria);
        $query->joinWith('NestleBowerSalesReport', $join_behavior);
    ...
    {
        return (string) $this->exportTo(NestleBowerInvoicesPeer::DEFAULT_STRING_FORMAT);
    }

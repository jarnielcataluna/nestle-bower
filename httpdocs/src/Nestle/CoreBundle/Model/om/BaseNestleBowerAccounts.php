...
abstract class BaseNestleBowerAccounts extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Nestle\\CoreBundle\\Model\\NestleBowerAccountsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        NestleBowerAccountsPeer
     */
     ...
     * @return NestleBowerAccounts The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = NestleBowerAccountsPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = NestleBowerAccountsPeer::NAME;
        }
    ...
    public function setContactPerson($v)
    {
        ...
        if ($this->contact_person !== $v) {
            ...
            $this->modifiedColumns[] = NestleBowerAccountsPeer::CONTACT_PERSON;
        }
    ...
    public function setContactNumber($v)
    {
        ...
        if ($this->contact_number !== $v) {
            ...
            $this->modifiedColumns[] = NestleBowerAccountsPeer::CONTACT_NUMBER;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[] = NestleBowerAccountsPeer::ADDRESS;
        }
    ...
    public function setAreaId($v)
    {
        ...
        if ($this->area_id !== $v) {
            $this->area_id = $v;
            $this->modifiedColumns[] = NestleBowerAccountsPeer::AREA_ID;
        }
    ...
    public function setCityId($v)
    {
        ...
        if ($this->city_id !== $v) {
            $this->city_id = $v;
            $this->modifiedColumns[] = NestleBowerAccountsPeer::CITY_ID;
        }
    ...
    public function setFrequency($v)
    {
        ...
        if ($this->frequency !== $v) {
            $this->frequency = $v;
            $this->modifiedColumns[] = NestleBowerAccountsPeer::FREQUENCY;
        }
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[] = NestleBowerAccountsPeer::CATEGORY_ID;
        }
    ...
    public function setChannel($v)
    {
        ...
        if ($this->channel !== $v) {
            $this->channel = $v;
            $this->modifiedColumns[] = NestleBowerAccountsPeer::CHANNEL;
        }
    ...
    public function setBracketNumber($v)
    {
        ...
        if ($this->bracket_number !== $v) {
            ...
            $this->modifiedColumns[] = NestleBowerAccountsPeer::BRACKET_NUMBER;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = NestleBowerAccountsPeer::STATUS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->area_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->city_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->frequency = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->category_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            $this->channel = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->bracket_number = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
            ...
            return $startcol + 12; // 12 = NestleBowerAccountsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating NestleBowerAccounts object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = NestleBowerAccountsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = NestleBowerAccountsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NestleBowerAccountsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NestleBowerAccountsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(NestleBowerAccountsPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(NestleBowerAccountsPeer::CONTACT_PERSON)) {
            $modifiedColumns[':p' . $index++]  = '`contact_person`';
        }
        if ($this->isColumnModified(NestleBowerAccountsPeer::CONTACT_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = '`contact_number`';
        }
        if ($this->isColumnModified(NestleBowerAccountsPeer::ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`address`';
        }
        if ($this->isColumnModified(NestleBowerAccountsPeer::AREA_ID)) {
            $modifiedColumns[':p' . $index++]  = '`area_id`';
        }
        if ($this->isColumnModified(NestleBowerAccountsPeer::CITY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`city_id`';
        }
        if ($this->isColumnModified(NestleBowerAccountsPeer::FREQUENCY)) {
            $modifiedColumns[':p' . $index++]  = '`frequency`';
        }
        if ($this->isColumnModified(NestleBowerAccountsPeer::CATEGORY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`category_id`';
        }
        if ($this->isColumnModified(NestleBowerAccountsPeer::CHANNEL)) {
            $modifiedColumns[':p' . $index++]  = '`channel`';
        }
        if ($this->isColumnModified(NestleBowerAccountsPeer::BRACKET_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = '`bracket_number`';
        }
        if ($this->isColumnModified(NestleBowerAccountsPeer::STATUS)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`channel`':
                        ...
                        break;
                    case '`bracket_number`':
                        $stmt->bindValue($identifier, $this->bracket_number, PDO::PARAM_INT);
                        break;
                    case '`status`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = NestleBowerAccountsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = NestleBowerAccountsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['NestleBowerAccounts'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['NestleBowerAccounts'][$this->getPrimaryKey()] = true;
        $keys = NestleBowerAccountsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            ...
            $keys[5] => $this->getAreaId(),
            $keys[6] => $this->getCityId(),
            $keys[7] => $this->getFrequency(),
            $keys[8] => $this->getCategoryId(),
            $keys[9] => $this->getChannel(),
            $keys[10] => $this->getBracketNumber(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setAreaId($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setCityId($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setFrequency($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setCategoryId($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setChannel($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setBracketNumber($arr[$keys[10]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NestleBowerAccountsPeer::ID)) $criteria->add(NestleBowerAccountsPeer::ID, $this->id);
        if ($this->isColumnModified(NestleBowerAccountsPeer::NAME)) $criteria->add(NestleBowerAccountsPeer::NAME, $this->name);
        if ($this->isColumnModified(NestleBowerAccountsPeer::CONTACT_PERSON)) $criteria->add(NestleBowerAccountsPeer::CONTACT_PERSON, $this->contact_person);
        if ($this->isColumnModified(NestleBowerAccountsPeer::CONTACT_NUMBER)) $criteria->add(NestleBowerAccountsPeer::CONTACT_NUMBER, $this->contact_number);
        if ($this->isColumnModified(NestleBowerAccountsPeer::ADDRESS)) $criteria->add(NestleBowerAccountsPeer::ADDRESS, $this->address);
        if ($this->isColumnModified(NestleBowerAccountsPeer::AREA_ID)) $criteria->add(NestleBowerAccountsPeer::AREA_ID, $this->area_id);
        if ($this->isColumnModified(NestleBowerAccountsPeer::CITY_ID)) $criteria->add(NestleBowerAccountsPeer::CITY_ID, $this->city_id);
        if ($this->isColumnModified(NestleBowerAccountsPeer::FREQUENCY)) $criteria->add(NestleBowerAccountsPeer::FREQUENCY, $this->frequency);
        if ($this->isColumnModified(NestleBowerAccountsPeer::CATEGORY_ID)) $criteria->add(NestleBowerAccountsPeer::CATEGORY_ID, $this->category_id);
        if ($this->isColumnModified(NestleBowerAccountsPeer::CHANNEL)) $criteria->add(NestleBowerAccountsPeer::CHANNEL, $this->channel);
        if ($this->isColumnModified(NestleBowerAccountsPeer::BRACKET_NUMBER)) $criteria->add(NestleBowerAccountsPeer::BRACKET_NUMBER, $this->bracket_number);
        if ($this->isColumnModified(NestleBowerAccountsPeer::STATUS)) $criteria->add(NestleBowerAccountsPeer::STATUS, $this->status);
    ...
    {
        $criteria = new Criteria(NestleBowerAccountsPeer::DATABASE_NAME);
        $criteria->add(NestleBowerAccountsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of NestleBowerAccounts (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return NestleBowerAccounts Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return NestleBowerAccountsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new NestleBowerAccountsPeer();
        }
    ...
    public function getNestleBowerArea(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aNestleBowerArea === null && ($this->area_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aNestleBowerArea->addNestleBowerAccountss($this);
             */
        }
    ...
    public function getNestleBowerCity(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aNestleBowerCity === null && ($this->city_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aNestleBowerCity->addNestleBowerAccountss($this);
             */
        }
    ...
    public function getNestleBowerCategory(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aNestleBowerCategory === null && ($this->category_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aNestleBowerCategory->addNestleBowerAccountss($this);
             */
        }
     ...
     * If this NestleBowerAccounts is new, it will return
        ...
        if (null === $this->collNestleBowerAccounts || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collNestleBowerAccounts) {
                ...
                $collNestleBowerAccounts = NestleBowerAccountQuery::create(null, $criteria)
                    ->filterByNestleBowerAccounts($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setNestleBowerAccounts(PropelCollection $nestleBowerAccounts, PropelPDO $con = null)
    {
        ...
        foreach ($nestleBowerAccountsToDelete as $nestleBowerAccountRemoved) {
            $nestleBowerAccountRemoved->setNestleBowerAccounts(null);
        }
    ...
    protected function doAddNestleBowerAccount($nestleBowerAccount)
    {
        ...
        $nestleBowerAccount->setNestleBowerAccounts($this);
    }
    ...
    public function removeNestleBowerAccount($nestleBowerAccount)
    {
        if ($this->getNestleBowerAccounts()->contains($nestleBowerAccount)) {
            ...
            $nestleBowerAccount->setNestleBowerAccounts(null);
        }
     ...
     * Otherwise if this NestleBowerAccounts is new, it will return
     * an empty collection; or if this NestleBowerAccounts has previously
     * been saved, it will retrieve related NestleBowerAccounts from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in NestleBowerAccounts.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(NestleBowerAccountsPeer::DEFAULT_STRING_FORMAT);
    }
